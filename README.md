...
> **한국어**
> Claude Code를 쓰면서 규칙·훅·스킬을 점점 늘려가다 보면, `CLAUDE.md` 하나에 모든 게 쌓여 토큰을 잡아먹고 모델의 주의력이 흩어집니다. 이 레포는 그 문제를 푸는 **"하네스(harness)" 구조**를 처음 접하는 사람도 쓸 수 있게 정리한 **설치 안내 도구 + 예시 자료집**입니다.
>
